...
public class RxTransformHelper {
     ...
     * @return
     */
    public static <stream> ObservableTransformer<stream, stream> ioMainProgress(final IView view, final String msg, final boolean canDismiss){
     ...
     * @return
     */
    public static <stream> ObservableTransformer<stream, stream> ioMainProgress(final IView view, final int msgId, final boolean canDismiss){
        return new ObservableTransformer<stream, stream>() {
            @Override
            public ObservableSource<stream> apply(Observable<stream> upstream) {
                return upstream.doOnSubscribe(new Consumer<Disposable>() {
     ...
     * @return
     */
    public static <stream> ObservableTransformer<stream, stream> ioMainException(final IView view){
        return new ObservableTransformer<stream, stream>() {
            @Override
            public ObservableSource<stream> apply(Observable<stream> upstream) {
